...
export async function probeWellKnown(domain, options = {}) {
    const { timeout = 5000, signal, fetch: fetchImpl = globalThis.fetch, scheme = "https", } = options;
    if (typeof fetchImpl !== "function") {
        throw new TypeError("probeWellKnown: no fetch implementation available. Pass options.fetch or run in an environment that has globalThis.fetch.");
    }
